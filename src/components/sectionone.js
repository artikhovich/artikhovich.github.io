import React from 'react';
        let content=[
        {title:'Аранжировка',text:'Суть аранжировки состоит в приведении в порядок изначальной идеи музыкальной темы. Если вы обращаетесь с просьбой аранжировать вашу музыкальную тему, то моя задача оформить ВАШУ тему учитывая ваши пожелания о составе инструментов, диапазоне участников ансамбля, продолжительности звучания будущего произведения и других тонкостей которые могут быть оговорены при заключении соглашения о сотрудничестве.'},
        {title:'Внимательность',text:'Вы можете указать строго темп будущего произведения, при этом сопровождаться ваше пожелание может записью на диктофон ваших импровизаций и комментариев.'},
        {title:'Своевременность',text:'По прошествии некоторого (не более оговариваемого с вами) времени, я вам предоставляю нотный материал и звуковой образец выполненный при помощи компьютера, где прозвучит аранжированная мною, предложенная вами тема. После этого события возможны корректировки некоторых параметров аранжировки. Все это оговаривается, корректируется и выполняется.'},
        ];
